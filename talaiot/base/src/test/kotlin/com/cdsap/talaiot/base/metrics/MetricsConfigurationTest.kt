...
import com.cdsap.talaiot.base.assertions.shouldContainExactlyTypesOfInAnyOrder
...
import com.cdsap.talaiot.base.mock.AdbVersionMetric
import com.cdsap.talaiot.base.mock.KotlinVersionMetric
...
class MetricsConfigurationTest : BehaviorSpec({
    given("metrics configuration") {
        val defaultMetricsTypes = listOf(
        ...
        val performanceMetricsTypes = listOf(
        ...
        val environmentMetricsTypes = listOf(
        ...
        val gitMetricsTypes = listOf(
            GitBranchMetric::class,
            GitUserMetric::class
        )

        val gradleSwitchesMetricsTypes = listOf(
